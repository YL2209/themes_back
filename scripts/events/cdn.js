...
hexo.extend.filter.register('before_generate', () => {
  ...
  const internalSrc = {
    ...
    translate: {
      name: 'hexo-theme-butterfly',
      file: 'https://npm.onmicrosoft.cn/naokuo-blog@1.0.17/js/tw_cn.js',
      version
    },
    local_search: {
      name: 'hexo-theme-butterfly',
      file: 'https://npm.onmicrosoft.cn/naokuo-blog@1.0.17/js/local-search.js',
      version
    },
    algolia_js: {
      name: 'hexo-theme-butterfly',
      file: 'https://npm.onmicrosoft.cn/naokuo-blog@1.0.17/js/algolia.js',
      version
    }
  }
